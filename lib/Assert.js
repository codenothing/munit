...
Assert.prototype = {
	...
	junit: function(){
		var self = this,
			xml = "<testsuite name='" + MUnit._xmlEncode( self.nsPath ) + "' tests='" + self.count + "' failures='" + self.failed + "' time='" + ( ( self.end - self.start ) / 1000 ) + "'>";
...
AssertResult.prototype = {
	...
	junit: function(){
		...
		return "<testcase name='" + MUnit._xmlEncode( self.name ) + "' classname='" + MUnit._xmlEncode( self.nsPath ) + "' time='" + ( self.time / 1000 ) + "'></testcase>";
	}
